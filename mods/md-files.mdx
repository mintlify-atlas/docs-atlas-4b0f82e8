...
<Info>
As of [CLI v3.5.0](https://github.com/geode-sdk/cli/releases/tag/v3.5.0), if a `README.md` is present but not an `about.md`, the readme will be used as the mod description.
