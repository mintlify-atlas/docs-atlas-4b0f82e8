---
title: Chapter 2.1 - Reverse Engineering
description: Introduction to reverse engineering and the tools used for GD modding
---
...
<Info>
You can switch themes by going in `Edit > Theme > Switch...`
</Info>
