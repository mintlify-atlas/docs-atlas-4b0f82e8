---
title: Chapter 2.5 - Finding Callbacks
description: Learn how to find button callback functions in GD
---
...
<Warning>
Note the calling convention being `__fastcall` rather than `__thiscall` - this will be explained later!
</Warning>
