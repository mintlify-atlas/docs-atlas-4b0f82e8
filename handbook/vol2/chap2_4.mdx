---
title: Chapter 2.4 - Comparing Against Android
description: Use Android GD's symbols to verify your reverse engineering work
---
...
<Warning>
ARMv8 support in Ghidra broke in version 11, so you'd preferably get the ARMv7 version.
</Warning>
...
<Warning>
The reason the **calling convention** of `LevelSettingsLayer::init` is `__thiscall` will be explained in a later chapter - not all functions have the same calling convention!
</Warning>
