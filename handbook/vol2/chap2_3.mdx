---
title: Chapter 2.3 - Finding LevelSettingsLayer::init
description: Learn how to find non-virtual init functions by following constructors and create functions
---
