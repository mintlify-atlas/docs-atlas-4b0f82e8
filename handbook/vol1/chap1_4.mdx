---
title: Chapter 1.4 - Cocos2d
description: Understanding GD's game engine and the node-based UI system
---
...
<Warning>
Some old modding tutorials on YouTube might tell you to use libraries such as CappuccinoSDK or Cocos-Headers - these are the traditional 2.1 libraries used, however they are nowadays obsolete.
</Warning>
...
<Warning>
Please note that the above image has been simplified and some of the positions do not reflect the actual arrangement of `CommentCell`.
</Warning>
