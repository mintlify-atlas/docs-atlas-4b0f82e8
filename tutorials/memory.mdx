...
description: Learn how Cocos2d's memory management system works and how to use Geode's Ref and WeakRef classes
---
...
<Warning>
You should never call `release` more than the amount of times you have called `retain` on an object to force-free it, as if some other code holds a pointer to the object and is expecting it to be retained, you will cause that code to break.
</Warning>
