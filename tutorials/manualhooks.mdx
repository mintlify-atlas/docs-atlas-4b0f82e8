---
title: Manual Hooks
description: Learn how to manually add hooks in Geode without using $modify
---
...
<Warning>
This function can be hooked normally using `$modify` - this is just an example! **Do not do this!**
</Warning>
