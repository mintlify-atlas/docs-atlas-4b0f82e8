---
title: Getting Nodes
description: Learn how to safely retrieve nodes from the Cocos2d node tree using string IDs instead of unreliable index-based access
---
