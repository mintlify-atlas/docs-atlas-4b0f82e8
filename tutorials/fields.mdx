---
title: Fields
description: Learn how to add custom member variables to modified classes
---
...
<Note>
Fields are initialized only whenever they're first accessed, **not** when the modified class is originally created.
</Note>
...
<Warning>
Do not use `typeinfo_cast` here, as it isn't actually an instance of `MyGameObject`. 
</Warning>
