---
title: Hook Priority
description: Learn how to control when your hooks are called in relation to other hooks on the same function
---
...
<Warning>
This is advanced functionality! Most developers will not need to touch this system.
</Warning>
