...
description: Learn how to set up and build Geode mods for iOS devices
---
...
<Warning>
The web server for the TrollStore version of the launcher will not work properly. It is recommended to use `scp` to upload your mods instead.
</Warning>
